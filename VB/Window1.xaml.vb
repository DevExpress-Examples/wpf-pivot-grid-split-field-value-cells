...
Namespace DXPivotGrid_SplittingCells
	Partial Public Class Window1
		...
		Private Sub pivotGrid_CustomFieldValueCells(ByVal sender As Object, ByVal e As PivotCustomFieldValueCellsEventArgs)
			...
			Dim condition As New Predicate(Of FieldValueCell)(Function(matchCell As FieldValueCell)
				Return matchCell.ValueType = FieldValueType.GrandTotal AndAlso matchCell.Field Is Nothing
			End Function)
